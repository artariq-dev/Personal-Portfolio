...
export const coreProjects = [
  ...
  },
  {
    ...
    techStack: ["Nuxt 3", "Vue 3 + TypeScript", "Strapi CMS", "Tailwind CSS", "Cloudflare Workers", "EmailOctopus", "Calendly"],
    stats: [],
  },
  {
  ...
  },
  {
    ...
    techStack: ["Nuxt 2", "Vue 2", "Vue Storefront 2", "Magento 2 GraphQL", "Pinia", "nuxt-i18n"],
    stats: [],
  },
  {
    slug: "agency-birdie",
    ...
    techStack: ["Nuxt 3", "Vue 3", "Firebase (Firestore)", "Stripe", "vue-i18n", "Tailwind CSS", "Headless UI"],
    stats: [],
  },
];
